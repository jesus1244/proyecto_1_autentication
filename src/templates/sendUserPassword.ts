const sendUserPassword= (username: string, password: string) => {
    return `
    <html lang="en">
    ...
    <body style="padding: 100px 0;background-color: #000;">
        <div style="width: 100%;display: block;text-align: center;">
            <div style="display: inline-block;text-align: center;width: 960px;max-width: 100%;background-color: #9895bd;">
                <div style="width: 100%;display: block;padding-bottom: 40%;background-image: url(https://i.ibb.co/TH4mG5b/Geography-by-Linn-Fritz.gif);background-repeat: no-repeat, repeat;background-size: contain;background-position: center;"></div>
                <div style="width: 100%;display: block;text-align: center;background-image: url(https://i.ibb.co/Y06kH03/fondo.jpg);background-repeat: no-repeat;background-position: 0 40px;background-size: cover;">
                    <div style="text-align: center;display: inline-block;padding: 3.13% 4.17%;width: 65%;max-width: 620px;border-radius: 15px;box-shadow: 30px 40px 100px rgba(0,0,0, 0.066604);background-color: #fff;margin-bottom: 50px;">
                        ...
                        <h2 style="margin: 0;margin-bottom: 15px;opacity: 1;color: rgba(134,168,49,1);font-size: 25px;font-weight: 600;font-style: normal;letter-spacing: 0px;text-align: center;line-height: 28px;font-family: 'Poppins', sans-serif;">Bienvenido a Xplorer Go!</h2>
                        <p style="color: #000;margin: 0;font-family: 'Poppins', sans-serif;opacity: 1;margin-bottom: 10px;font-size: 16px;font-weight: 500;font-style: normal;letter-spacing: 0px;text-align: center;line-height: 22px;max-width: 100%;display: block;">A continuación encontrarás tu usuario y contraseña con el cual puedes ingresar a la plataforma</p>
                        <p style="color: #000;margin: 0;font-family: 'Poppins', sans-serif;opacity: 1;margin-bottom: 30px;font-size: 16px;font-weight: 500;font-style: normal;letter-spacing: 0px;text-align: center;line-height: 22px;max-width: 100%;display: block;">Usuario: ${username} <br> Contraseña: ${password}</p>
